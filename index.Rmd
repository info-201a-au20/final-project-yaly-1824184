...
this data the highest gross movie is `r Highest_Gross_Movie`. Also, the lowest gross movies would be the movies `r Lowest_Gross_Movies`. With this being said, the most common genre from the data 
