...
this data the highest gross movie is `r summary$Highest_Gross_Movie`. Also, the lowest 
gross movies would be the movies `r summary$Lowest_Gross_Movies`. With this being said, 
the most common genre from the data are `r summary$Most_Common_Genre` and the most 
common release date year would be the `r summary$Most_Common_Release_Year`. Finally, 
in this data it displays `r summary$Total_Movies`. This can all be seen below.
